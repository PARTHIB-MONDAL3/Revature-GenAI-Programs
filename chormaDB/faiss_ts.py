...
index.hnsw.efConstruction = 80  # trade-off: build time vs quality
index.hnsw.efSearch = 100        # trade-off: query latency vs recall
...
query = np.array([[0.11, 0.88, 0.0, 0.0]], dtype='float32')  # shape (1, 4)
